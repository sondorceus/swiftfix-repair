                ...
                <div className="grid grid-cols-2 gap-3">
                  {IPHONE_SERIES.map((s) => (
                    <button
                      ...
                      className="group relative flex flex-col items-center p-4 pb-5 rounded-2xl bg-gradient-to-r from-[#c8d9ea] via-[#b4c8de] to-[#9db8d6] border border-[#e8e8ed] hover:border-[#0071e3]/50 hover:from-white hover:via-white hover:to-white hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 cursor-pointer"
                    >
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-4 p-5 rounded-2xl border-2 transition-all duration-200 cursor-pointer text-left ${
                      isSelected
                        ...
                        : "border-[#e8e8ed] bg-gradient-to-r from-[#c8d9ea] via-[#b4c8de] to-[#9db8d6] hover:border-[#0071e3]/50 hover:from-white hover:via-white hover:to-white hover:shadow-lg"
                    }`}
                  >
                    ...
                    <button
                      ...
                      className={`flex-shrink-0 px-4 py-3 rounded-xl text-center text-sm font-medium transition cursor-pointer border ${
                        selectedDate === d.value
                          ...
                          : "border-[#e8e8ed] bg-gradient-to-r from-[#c8d9ea] via-[#b4c8de] to-[#9db8d6] text-[#1a1a1a] hover:border-[#0071e3]/50 hover:from-white hover:via-white hover:to-white"
                      }`}
                    >
                      {d.label}
                    </button>
