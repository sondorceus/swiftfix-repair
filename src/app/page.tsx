...
const IPHONE_SERIES = [
  ...
  { id: "16", label: "iPhone 16", image: "/iphone16.png?v=3", year: "2024", frame: "#3C3C3C", accent: "#7856FF", notch: "dynamic", cameras: 3, edges: "round",
    variants: [
                  ...
                  {IPHONE_SERIES.map((s, idx) => (
                    ...
                    >
                      {(s as { image?: string }).image ? (
                        <img src={(s as { image?: string }).image} alt={s.label} className="w-16 h-16 object-contain mb-2 group-hover:scale-110 transition-transform" style={(s.id === "16" || s.id === "15") ? { transform: "scale(1.07)" } : undefined} />
                      ) : (
