...
const IPHONE_SERIES = [
  ...
  { id: "16", label: "iPhone 16", image: "/iphone16.png?v=2", year: "2024", frame: "#3C3C3C", accent: "#7856FF", notch: "dynamic", cameras: 3, edges: "round",
    variants: [
  ...
  { id: "15", label: "iPhone 15", year: "2023", frame: "#2C2C2E", accent: "#0071e3", notch: "dynamic", cameras: 3, edges: "round", image: "/iphone15.png?v=2",
    variants: [
                  ...
                  {IPHONE_SERIES.map((s, idx) => (
                    ...
                    >
                      {(s as { image?: string }).image ? (
                        <img src={(s as { image?: string }).image} alt={s.label} className="w-16 h-16 object-contain mb-2 group-hover:scale-110 transition-transform" style={{ filter: "contrast(1.15) brightness(1.05) saturate(1.1)", mixBlendMode: "multiply" }} />
                      ) : (
