                ...
                <div className="grid grid-cols-2 gap-3">
                  {IPHONE_SERIES.map((s) => (
                    <button
                      ...
                      className="group relative flex flex-col items-center p-4 pb-5 rounded-2xl bg-[#dbe7f4] border border-[#e8e8ed] hover:border-[#0071e3]/50 hover:bg-white hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 cursor-pointer"
                    >
                    ...
                    <div className="space-y-2">
                      {series.variants.map((v) => (
                        <button
                          ...
                          className="w-full flex items-center justify-between p-4 rounded-2xl bg-[#dbe7f4] border border-[#e8e8ed] hover:border-[#0071e3]/50 hover:bg-white hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 cursor-pointer text-left"
                        >
                          <div className="flex items-center gap-3">
            ...
            <div className="space-y-2">
              {currentRepairs.map((r) => (
                <button
                  ...
                  className="w-full flex items-center gap-4 p-4 rounded-2xl bg-[#dbe7f4] border border-[#e8e8ed] hover:border-[#0071e3]/50 hover:bg-white hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 cursor-pointer text-left"
                >
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-4 p-5 rounded-2xl border-2 transition-all duration-200 cursor-pointer text-left ${
                      isSelected
                        ...
                        : "border-[#e8e8ed] bg-[#dbe7f4] hover:border-[#0071e3]/50 hover:bg-white hover:shadow-lg"
                    }`}
                  >
                    ...
                    <button
                      ...
                      className={`flex-shrink-0 px-4 py-3 rounded-xl text-center text-sm font-medium transition cursor-pointer border ${
                        selectedDate === d.value
                          ...
                          : "border-[#e8e8ed] bg-[#dbe7f4] text-[#1a1a1a] hover:border-[#0071e3]/50 hover:bg-white"
                      }`}
                    >
                      {d.label}
                    </button>
